            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="index.html" class="header-logo">
                        ...
                        <img src="{{ asset(get_admin_template_base_path() . '/images/brand-logos/toggle-logo.png') }}"
        ...
        <div class="header-content-right">
            ...
            <div class="header-element country-selector">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside"
                    ...
                    <img src="{{ asset(get_admin_template_base_path() . '/images/flags/us_flag.jpg') }}" alt="img"
                ...
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/flags/us_flag.jpg') }}"
                                    alt="img">
                            </span>
                            English
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/flags/spain_flag.jpg') }}"
                                    alt="img">
                            </span>
                            Spanish
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/flags/french_flag.jpg') }}"
                                    alt="img">
                            </span>
                            French
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/flags/germany_flag.jpg') }}"
                                    alt="img">
                            </span>
                            German
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/flags/italy_flag.jpg') }}"
                                    alt="img">
                            </span>
                            Italian
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/flags/russia_flag.jpg') }}"
                                    alt="img">
                            </span>
                            Russian
                        </a>
                    ...
                    <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/ecommerce/jpg/1.jpg') }}"
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/ecommerce/jpg/3.jpg') }}"
                                    alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark fw-semibold">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/ecommerce/jpg/5.jpg') }}"
                                    alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark fw-semibold">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/ecommerce/jpg/4.jpg') }}"
                                    alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark fw-semibold">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                <img src="{{ asset(get_admin_template_base_path() . '/images/ecommerce/jpg/6.jpg') }}"
                                    alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark fw-semibold">
                        ...
                        <div class="row g-2">
                                ...
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/figma.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/microsoft-powerpoint.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/microsoft-word.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/calender.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/sketch.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/google-docs.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/google.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/translate.png') }}"
                                                alt="">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);">
                                    <div class="text-center p-3 related-app">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="{{ asset(get_admin_template_base_path() . '/images/apps/google-sheets.png') }}"
                                                alt="">
                                        </span>
                ...
                <a href="#" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-sm-2 me-0">
                            <img src="{{ asset(get_admin_template_base_path() . '/images/faces/9.jpg') }}"
